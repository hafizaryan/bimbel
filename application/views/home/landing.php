			...
			<div class="container">
				<div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
					<div class="col-md-8 text-center ftco-animate">
						<h1 class="mb-4">Selamat Datang Di Website  <span> Bimbel Atasee</span></h1>
			...
			<div class="row no-gutters">
				...
				<div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-tertiary">
					<div class="media block-6 d-block text-center">
						...
						<div class="media-body p-2 mt-3">
							...
							<p>Pendidikan khusus untuk anak anak anda</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-fifth">
					<div class="media block-6 d-block text-center">
						...
						<div class="media-body p-2 mt-3">
							<h3 class="heading">Buku &amp; Materi</h3>
			...
			<div class="row">
				<div class="col-md-5 order-md-last wrap-about py-5 wrap-about bg-light">
					<div class="text px-4 ftco-animate">
						<h2 class="mb-4">Selamat datang di Bimbel CV Atasee</h2>
						<p>Atasee adalah sebuah lembaga pendidikan yang terletak di Pangkalan Kerinci.</p>
						<p>Lembaga ini berkonsentrasi pada program-program belajar yang ditujukan untuk
							mengembangkan serta mengoptimalkan potensi kecerdasan siswa. Diharapkan
							keberadaan Atasee dapat menjadi mitra terbaik bagi orang tua dan sekolah dalam
				...
				<div class="col-md-7 wrap-about py-5 pr-md-4 ftco-animate">
					...
					<p>Atasee telah membuat program belajar bagi anak
						...
						<div class="col-lg-6">
							<div class="services-2 d-flex">
								...
								<div class="text">
									...
									<p> Bimbel Kami Terbagi Dari Beberapa Kategori Kelas yaitu Membaca, Komputer, Bahasa Inggris 
										Dan Lainnya.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="services-2 d-flex">
								...
								<div class="text">
									...
									<p>Terdapat Ruang Kelas Yang Luas Dan Nyaman</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="services-2 d-flex">
								...
								<div class="text">
									...
									<p>Ada fasilitas belajar yang lengkap dan mumpuni dan mampu melengkapi kebutuhan anak anda</p>
								</div>
							</div>
						</div>
					</div>
	...
	<section class="ftco-intro" style="background-image: url(<?= base_url(); ?>assets/User/images/bg_3.jpeg);" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
				<div class="col-md-9">
				...
				<div class="col-md-3 d-flex align-items-center">
					<?php if ($this->session->userdata('is_user_login') == true) : ?>
						<p class="mb-0"><a href="<?= base_url(); ?>home/form" class="btn btn-secondary px-4 py-3">Daftar</a></p>
					<?php elseif ($this->session->userdata('is_admin_login') == true) : ?>
						<p class="mb-0"><a href="<?= base_url(); ?>admin/dashboard" class="btn btn-secondary px-4 py-3">Daftar</a></p>
					<?php else : ?>
						<p class="mb-0"><a href="<?= base_url(); ?>auth/login" class="btn btn-secondary px-4 py-3">Daftar</a></p>
					<?php endif; ?>
		...
		<div class="container">
			<div class="row justify-content-center mb-5 pb-2">
				<div class="col-md-8 text-center heading-section ftco-animate">
					<h2 class="mb-4"><span>Kelas</span> Kami</h2>
					<p>Kelas Kami Terbuka Untuk Anak SD, SMP, SMA, Dan Umum</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6 course d-lg-flex ftco-animate">
					...
					<div class="text bg-light p-4">
						<h3><a href="#">Kelas Program Komputer</a></h3>
						<!-- <p class="subheading"><span>Class time:</span> 9:00am - 10am</p> -->
						<p>Kelas ini mengajarkan siswa untuk mahir menggunakan komputer dan mengoperasikan
							microsoft office.
						</p>
					</div>
				</div>
